...
verified: "f224f43a2027aee4413a6babc3ed89640d59be2dae206fa3e30c55f43afeb322"
...
Source fingerprint: `0c394fe350573efc6db49aef870c583969c3e1e3a63b26c8a8e57d319fcd538d`
...
- Selected cross-program work: `bundle:commander-pairing-keywords`
...
|---:|---|---|---|---:|---:|---:|---:|---:|---:|---:|
| 1 | selected | `bundle:commander-pairing-keywords` | `compiler_harvest` | 3 | 1 | 2 | 117 | 0.181818 | 0 | 0 |
...
| 5 | complete | `assurance:critical-interaction-recovery` | `interaction_assurance` | 1 | 0 | 0 | 0 | unknown | 0 | 0 |
...
| 29 | blocked | `frontier:effect_clause:typed-spell-additional-cost-clause` | `compiler_harvest` | 1 | 3 | 16 | 106 | 0.761905 | 0 | 0 |
...
Selected reason: Meets the measured major exact-ability floor inside one reusable grammar boundary. The bundle shares 4 canonical owners across 1 source contexts and is predicted at 0.181818 complete cards per cycle hour.
