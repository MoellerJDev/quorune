...
verified: "3caae3231c728dc0054c37875624520105519a4c989acbbe8f5fe2a74c272925"
...
- Mapped pinned rules: 844 / 3,300
- Applicable piece pairs: 36,100
- Covered piece pairs: 648
...
| `combat` — Combat | 24 |
| `compiler_cardprogram` — Compiler and CardProgram pieces | 522 |
| `continuous_effects` — Static abilities and continuous effects | 35 |
| `costs_mana` — Costs and mana | 8 |
| `events_mutations` — Typed events and mutations | 107 |
...
| `typed_transactions_events_mutations` | `inventoried` | 247 | 73 |

## Highest current blocker leverage

| Piece | Class | Residuals | Sole blockers | Expected cards | Runtime | Assurance |
|---|---|---:|---:|---:|---|---|
| `residual.continuous_layer.continuous-effect-layers-and-dependencies` | `continuous_effects` | 8,908 | 3,688 | 3,688 | `absent` | `untested` |
| `residual.effect_clause.unparsed-clause-grammar` | `one_shot_effects` | 2,955 | 290 | 290 | `absent` | `untested` |
...
| `residual.activated_effect.tap-state` | `one_shot_effects` | 318 | 35 | 35 | `absent` | `untested` |
