...
verified: "c405deaecadc0ddd9cfb84a9150b8e9881213fdd2a8ba7d988132de9863afe89"
...
- Mapped pinned rules: 707 / 3,300
- Applicable piece pairs: 23,644
...
| `combat` — Combat | 21 |
| `compiler_cardprogram` — Compiler and CardProgram pieces | 305 |
| `continuous_effects` — Static abilities and continuous effects | 16 |
| `costs_mana` — Costs and mana | 7 |
| `events_mutations` — Typed events and mutations | 76 |
...
| `typed_transactions_events_mutations` | `inventoried` | 178 | 58 |

## Highest current blocker leverage

| Piece | Class | Residuals | Sole blockers | Expected cards | Runtime | Assurance |
|---|---|---:|---:|---:|---|---|
| `residual.continuous_layer.continuous-effect-layers-and-dependencies` | `continuous_effects` | 9,561 | 3,359 | 3,359 | `absent` | `untested` |
| `residual.activated_effect.unparsed-clause-grammar` | `one_shot_effects` | 2,689 | 764 | 764 | `absent` | `untested` |
...
| `residual.mechanic_dependency.cr-509-declare-blockers-step` | `keyword_mechanics` | 428 | 143 | 143 | `absent` | `untested` |
