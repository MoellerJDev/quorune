...
verified: "63043a2283f8843207187eee54b647ccb8fe2445479bd012faa7f8b653f9857a"
...
- Mapped pinned rules: 870 / 3,300
- Applicable piece pairs: 39,110
- Covered piece pairs: 671
...
| `combat` — Combat | 24 |
| `compiler_cardprogram` — Compiler and CardProgram pieces | 641 |
...
| `one_shot_effects` — One-shot semantic effects | 149 |
...
| `typed_transactions_events_mutations` | `inventoried` | 257 | 75 |

## Highest current blocker leverage

| Piece | Class | Residuals | Sole blockers | Expected cards | Runtime | Assurance |
|---|---|---:|---:|---:|---|---|
| `residual.continuous_layer.continuous-effect-layers-and-dependencies` | `continuous_effects` | 8,884 | 3,774 | 3,774 | `absent` | `untested` |
| `residual.effect_clause.unparsed-clause-grammar` | `one_shot_effects` | 2,902 | 300 | 300 | `absent` | `untested` |
| `residual.activated_effect.unparsed-clause-grammar` | `one_shot_effects` | 2,114 | 169 | 169 | `absent` | `untested` |
