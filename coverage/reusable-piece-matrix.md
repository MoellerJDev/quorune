...
verified: "74ca5b2bd7069aa56db0ebea7f00a133d4c1f36cd1b8526b3716e8104df823e8"
...
- Mapped pinned rules: 805 / 3,300
- Applicable piece pairs: 28,430
...
| `combat` — Combat | 22 |
| `compiler_cardprogram` — Compiler and CardProgram pieces | 420 |
...
| `one_shot_effects` — One-shot semantic effects | 128 |
| `players_format` — Players, relationships, and format state | 1 |
| `proposals` — Casting and activation proposals | 11 |
...
|---|---|---:|---:|
| `action_legality_casting_activation_costs_mana` | `inventoried` | 51 | 6 |
...
| `typed_transactions_events_mutations` | `inventoried` | 227 | 67 |

## Highest current blocker leverage

| Piece | Class | Residuals | Sole blockers | Expected cards | Runtime | Assurance |
|---|---|---:|---:|---:|---|---|
| `residual.continuous_layer.continuous-effect-layers-and-dependencies` | `continuous_effects` | 9,288 | 3,605 | 3,605 | `absent` | `untested` |
